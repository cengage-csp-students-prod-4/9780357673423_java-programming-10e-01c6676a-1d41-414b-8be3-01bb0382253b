...
> The program's output is too large to include, so it has been condensed in the example above.

> Make sure to include "The population of Mexico will exceed the U.S. population in *X* years", where *X* is the number of years, in the program's output. 
